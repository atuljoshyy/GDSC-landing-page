...
const Hero = () => {
    return (
        <>
            <section class="w-full bg-[#F5F5F7] dark:bg-wickeddark font-poppins">
                <div class="relative items-center w-full px-5 pt-12 md:py-12 mx-auto md:px-12  lg:px-16 max-w-7xl lg:py-24 lg:pb-0">
                    <div class="flex flex-col w-full mx-auto text-left">
                        <div class="relative inline-flex items-center mx-auto align-middle">
                            <div class="text-center">
                                <h1 class="max-w-5xl text-5xl font-bold leading-none tracking-tighter text-neutral-600 md:text-5xl lg:text-6xl lg:max-w-7xl">
                                ...
                                <form action="" method="post" id="revue-form" name="revue-form" target="_blank" class="p-2 mt-8 transition duration-500 ease-in-out transform border2 bg-white md:mx-auto rounded-xl sm:max-w-lg sm:flex">
                                    <div class="flex-1 min-w-0 revue-form-group">
                                        <label for="search" class="sr-only">Search for your perfect illustration</label>
                                    ...
                                    <div class="mt-4 sm:mt-0 sm:ml-3 revue-form-actions">
                                        <button type="submit" value="Subscribe" name="member[subscribe]" id="member_submit" class=" hidden md:flex items-center   px-4 py-2 text-base font-medium text-neutral-600  border border-transparent rounded-lg hover:bg-gray-300 focus:outline-none ">
