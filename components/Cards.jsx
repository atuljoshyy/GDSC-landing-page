                                ...
                                <div className='flex space-x-2'>
                                    <div>
                                        <p className='flex items-center text-sm bg-yellow-50 px-4 py-2 rounded-lg text-gray-600 cursor-pointer'>SVG
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-bar-to-down" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#828282" fill="none" stroke-linecap="round" stroke-linejoin="round">
